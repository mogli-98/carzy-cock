        ...
        <>
                ...
                <div className="container">
                    <div className="box">
                        <center>
                            ...
                            <h1 className='Recipe-heading-top1 text-center mt-5'style={{width:"29%"}} >RARE BERRY</h1>
                            <hr />
                        </center>
            ...
            <ParallaxProvider>
                <section style={{ backgroundColor: "#233243", height: "50vw",marginTop:"-45vh" }} className='d-none d-md-block d-lg-block d-sm-none desktop' >
                    <Parallax translateY={[-20, 5]} speed={3000}>
                        <center>
                            ...
                            <div className="row pb-5">
                                <div className="col">
                                   <div className="recpie-tablebox1">
                                        ...
                                        <p className='text-light recpie-tablebox-even '>Nick & Nora, Vintage</p>
                                   </div>
                                    <div className="recpie-tablebox2">
                                        ...
                                        <p className='text-light recpie-tablebox-even'>Macaron Discarded Cream</p>
                                    </div>
                                    <div className="recipe-tablebox3">
                                        ...
                                        <p className='text-light recpie-tablebox-even'>Cube Chunk</p>
                                    </div>
                                    <div className="recipe-tablebox4">
                                        ...
                                        <p className='text-light recpie-tablebox-even text-bold'>50 ml Strawberry Butter Jam Whisky (Recipe below)<br />
                                            <span className='small'>15 ml Vermouth Rosso</span><br />
                                            <span className='small'>15 ml Tio Pepe Sherry</span>
                                            <span className='small'>3 bs Cynar Liqueur</span>
                                            <span className='small'>5 dashes Coffee Bitters</span>
                                            </p>
                                    </div>
                                </div>
                                <div className="col">
                                    ...
                                    <p className='text-light recpie-tablebox-even'>Stir all the above ingredients until icy cold and strain into a Vintage glass.
                                    </p>
                                    <div className="recipe-tablecol2-box">
                                        <p className='text-light '></p>
                                        <p className='text-light '><b>RECIPE FOR STRAWBERRY BUTTER JAM WHISKY</b><br />
                                           <span className='small'> INGREDIENTS</span><br />
                                           750 ml Crazy Cock Blended Whisky<br />
                                           150 gms Strawberry Jam <br/>
                                           150 gms Butter
                                        </p>
                                        <p className='text-light mt-5'></p>
                                        
                                        <p className='text-light small'>METHOD</p>
                                        <p className='text-light'>The first step is to seal the alcohol, strawberry jam and butter in a sous vide bag.<br />
                                            Cook for 1 hour at 60ºC. Filter with strainer and pour the liquid in a non-reactive container.<br />
                                            Freeze overnight. Once frozen, filter the whisky with a coffee filter and store in a bottle. Do not<br />
                                            toss away the strained Strawberry Butter Jam. Add equal parts sugar and blend. Use this cream<br />
                                            for the Macaron garnish.  
                                        </p>
                                    </div>
                                </div>
                            </div>
            ...
            <section className='d-sm-block d-md-none tablet top-section'>
                <div backgroundColor="#f0e9e3">
                    <center>
                        ...
                        <h1 className='Recipe-heading1-tab text-center'>RARE BERRY</h1>
            ...
            <section style={{ backgroundColor: 'black' }} className='section-03 d-sm-block d-md-none  tablet'>
                ...
                <div className='section-03-text'>
                    ...
                    <hr style={{ width: " 17%" }} />
                    <p>Nick & Nora, Vintage</p>
                    <h5>
                        GARNISH
                    </h5>
                    <hr style={{ width: " 25%" }} />
                    <p>Macaron Discarded Cream</p>
                    <h5>
                        ICE
                    </h5>
                    <hr style={{ width: " 12%" }} />
                    ...
                    <div className='spannn2'>
                        <span className='spannn'>50 ml Strawberry Butter Jam Whisky (Recipe below)</span> <br />
                        <span className='spannn1'>15 ml Vermouth Rosso</span><br />
                        <span className='spannn'>15 ml Tio Pepe Sherry</span><br />
                        <span className='spannn1'>3 bs Cynar Liqueur</span><br />
                        <span className='spannn'>5 dashes Coffee Bitters</span><br />
                    </div>
                    <h5 className='mt-4'>METHOD</h5>
                    <hr style={{ width: " 25%" }} />
                    <p className='mt-3'>Stir all the above ingredients until icy cold and strain into a Vintage glass.</p>
                    <h5>RECIPE FOR STRAWBERRY BUTTER JAM WHISKY</h5>
                    <h6 className='mt-4'>INGREDIENTS</h6>
                    <p className='mt-4'>750 ml Crazy Cock Blended Whisky</p>
                    <p>150 gms Strawberry Jam</p>
                    <p>150 gms Butter</p>
                    
                    <p className='mt-4'>
                        The first step is to seal the alcohol, strawberry jam and butter in a sous vide bag.<br />
                        Cook for 1 hour at 60ºC. Filter with strainer and pour the liquid in a non-reactive container.<br />
                        Freeze overnight. Once frozen, filter the whisky with a coffee filter and store in a bottle. Do not<br />
                        toss away the strained Strawberry Butter Jam. Add equal parts sugar and blend. Use this cream<br />
                        for the Macaron garnish.<br />
