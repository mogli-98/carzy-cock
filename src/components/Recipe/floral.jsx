                ...
                <div className="container">
                    <div className="box">
                        <center>
                            ...
                            <h1 className='Recipe-heading-top1 text-center mt-5' style={{width:"30%"}}>RARE FLORAL</h1>
                            <hr />
                        </center>
                                ...
                                <div className="col">
                                   <div className="recpie-tablebox1">
                                    ...
                                    <div className="recpie-tablebox2">
                                        ...
                                        <p className='text-light recpie-tablebox-even'>Cherry</p>
                                    </div>
                                    ...
                                    <div className="recipe-tablebox4">
                                        ...
                                        <p className='text-light recpie-tablebox-even text-bold'>50 ml Sakura Leaf Whisky (Recipe below)<br />
                                            <span className='small'>20 ml Floral Vermouth</span></p>
                                        <p className='text-light '>20 ml Campari <br />
                                            <span className='small'>2 bs Sugar Syrup</span></p>
                                        <p className='text-light pt-1'>Top Up Ginger Ale</p>
                                    </div>
                                </div>
                                <div className="col">
                                    <p className='text-light recpie-tablebox-odd'>METHOD</p>
                                    <hr style={{ color: "#fff", width: "21%" ,border:"1px solid #fff" }} />  
                                    <p className='text-light recpie-tablebox-even'>Pour all the above ingredients into a mixing glass, stir with ice and pour into highball.<br />Add Ginger Ale and garnish with a cherry .
                                    </p>
                                    <div className="recipe-tablecol2-box">
                                        <p className='text-light '></p>
                                        <p className='text-light '><b>RECIPE FOR SAKURA LEAF WHISKY</b><br />
                                           <span className='small'> INGREDIENTS</span><br />
                                           3 Sakura Leaves<br />
                                           750 ml Crazy Cock Blended Whisky
                                        </p>
                                        <p className='text-light mt-5'></p>
                                        
                                        <p className='text-light small'>METHOD</p>
                                        <p className='text-light'>In a cooking vacuum bag, add the above ingredients and sous vide for 1 hour at 60ºC.<br />
                                        Cool down, filter and bottle.<br />
            ...
            <section className='d-sm-block d-md-none tablet top-section'>
                <div backgroundColor="#f0e9e3">
                    <center>
                        ...
                        <h1 className='Recipe-heading1-tab text-center'>RARE FLORAL</h1>
            ...
            <section style={{ backgroundColor: 'black' }} className='section-03 d-sm-block d-md-none  tablet'>
                ...
                <div className='section-03-text'>
                    ...
                    <div className='spannn2'>
                        <span className='spannn'>50 ml Sakura Leaf Whisky (Recipe below)</span> <br />
                        <span className='spannn1'>20 ml Floral Vermouth</span><br />
                        <span className='spannn'>20 ml Campari</span><br />
                        <span className='spannn1'>2 bs Sugar Syrup</span><br />
                        <span className='spannn'>Top Up Ginger Ale</span><br />
                    </div>
                    <h5 className='mt-4'>METHOD</h5>
                    <hr style={{ width: " 25%" }} />
                    <p className='mt-3'>Pour all the above ingredients into a mixing glass, stir with ice and pour into highball. <br />Add Ginger Ale and garnish with a cherry .</p>
                    <h5>RECIPE FOR SAKURA LEAF WHISKY</h5>
                    <h6 className='mt-4'>INGREDIENTS</h6>
                    <p className='mt-4'>3 Sakura Leaves</p>
                    <p>750 ml Crazy Cock Blended Whisky</p>
