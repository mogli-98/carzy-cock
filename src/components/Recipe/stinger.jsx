                ...
                <div className="container">
                    <div className="box">
                        <center>
                            ...
                            <h1 className='Recipe-heading-top1 text-center mt-5' style={{width:"37%"}}>EXOTIC STINGER</h1>
                            <hr />
                        </center>
                        ...
                        <div className="container  recipetale ">
                            <div className="row pb-5">
                                <div className="col">
                                   <div className="recpie-tablebox1">
                                    ...
                                    <div className="recpie-tablebox2">
                                        ...
                                        <p className='text-light recpie-tablebox-even'>Bee Honey Comb Net</p>
                                    </div>
                                    ...
                                    <div className="recipe-tablebox4">
                                        ...
                                        <p className='text-light recpie-tablebox-even text-bold'>30 ml Bee Pollen Whisky <br />
                                            <span className='small'>(Recipe on the right)</span></p>
                                        <p className='text-light '>30 ml Campari Honey Comb <br />
                                            <span className='small'>(Recipe on the right)</span></p>
                                ...
                                <div className="col">
                                    ...
                                    <p className='text-light recpie-tablebox-even'>Stir all the ingredients until icy cold and strain <br />over a glass. Garnish with Bee Honey comb net.
                                    </p>
                                    <div className="recipe-tablecol2-box">
                                        ...
                                        <p className='text-light '><b>RECIPE FOR BEE POLLEN WHISKY</b><br />
                                           <span className='small'> INGREDIENTS</span><br />
                                            750 ml Crazy Cock Exotic Whisky<br />
                                            100 gms Bee Pollen
                                        </p>
                                        <p className='text-light mt-5'></p>
                                        
                                        <p className='text-light small'>METHOD</p>
                                        <p className='text-light'>Set Rotavap to distill for 3h at 40°C bath, 100<br />
            ...
            <section className='d-sm-block d-md-none tablet top-section'>
                <div backgroundColor="#f0e9e3">
                    <center>
                        ...
                        <h1 className='Recipe-heading1-tab text-center'>EXOTIC STINGER</h1>
            ...
            <section style={{ backgroundColor: 'black' }} className='section-03 d-sm-block d-md-none  tablet'>
                ...
                <div className='section-03-text'>
                    ...
                    <div className='spannn2'>
                        <span className='spannn'>30 ml Bee Pollen Whisky</span> <br />
                        <span className='spannn1' s>(Recipe on the right)</span><br />
                    ...
                    <hr style={{ width: " 25%" }} />
                    <p className='mt-3'>Stir all the ingredients until icy cold and strain <br />over a glass. Garnish with Bee Honey comb net.</p>
                    <h5>RECIPE FOR BEE POLLEN WHISKY</h5>
                    <h6 className='mt-4'>INGREDIENTS</h6>
                    <p className='mt-4'>750 ml Crazy Cock Exotic Whisky</p>
                    <p>100 gms Bee Pollen </p>
                    <h6 className='mt-5'>
                        METHOD
                    </h6>
                    <p className='mt-4'>
