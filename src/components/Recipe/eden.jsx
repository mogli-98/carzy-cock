                ...
                <div className="container">
                    <div className="box">
                        <center>
                            ...
                            <h1 className='Recipe-heading-top1 text-center mt-5 ' style={{width:"30%"}}>SMOKY EDEN</h1>
                            <hr />
                        </center>
                        ...
                        <div className="container  recipetale ">
                            <div className="row pb-5">
                                <div className="col">
                                   <div className="recpie-tablebox1">
                                    ...
                                    <div className="recpie-tablebox2">
                                        ...
                                        <p className='text-light recpie-tablebox-even'>Pineapple Leather and Caviar</p>
                                    </div>
                                    ...
                                    <div className="recipe-tablebox4">
                                        ...
                                        <p className='text-light recpie-tablebox-even text-bold'>40ml Crazy Cock Peated Malt <br />
                                            <span className='small'>10ml Hops Distillate</span></p>
                                        <p className='text-light '>60ml Clarified Pineapple Sherbet<br />
                                            <span className='small'>30ml Soda Water</span></p>
                                ...
                                <div className="col">
                                    ...
                                    <p className='text-light recpie-tablebox-even'>Stir all the above ingredients until icy cold and strain over a glass.<br />Top up with water.
                                    </p>
                                    <div className="recipe-tablecol2-box">
                                        <p className='text-light '></p>
                                        <p className='text-light '><b>RECIPE FOR HOPS DISTILLATE</b><br />
                                        ...
                                        <p className='text-light'>Set Rotavap to distill for 3h at 40 º C bath, 100 vacuum pump and chiller at 0 º C. Place the<br />
                                        ingredients into a flask and distill until all the liquid is collected at the other end. Measure the<br />
                                        ABV with a refractometer and rectify with mineral water until ABV touches 43%.<br />
                                        Store in a bottle.<br />
        ...
        <div className="container">
            ...
            <section className='d-sm-block d-md-none tablet top-section'>
                <div backgroundColor="#f0e9e3">
                    <center>
                        ...
                        <h1 className='Recipe-heading1-tab text-center'>SMOKY EDEN</h1>
            ...
            <section style={{ backgroundColor: 'black' }} className='section-03 d-sm-block d-md-none  tablet'>
                ...
                <div className='section-03-text'>
                    ...
                    <hr style={{ width: " 25%" }} />
                    <p>Pineapple Leather and Caviar</p>
                    <h5>
                        ICE
                    </h5>
                    <hr style={{ width: " 12%" }} />
                    ...
                    <div className='spannn2'>
                        <span className='spannn'>40ml Crazy Cock Peated Malt</span> <br />
                        <span className='spannn1'>10ml Hops Distillate</span><br />
                        <span className='spannn'>30 ml Campari Honey Comb</span><br />
                        <span className='spannn1'>60ml Clarified Pineapple Sherbet</span><br />
                        <span className='spannn'>30ml Soda Water</span><br />
                    </div>
                    <h5 className='mt-4'>METHOD</h5>
                    <hr style={{ width: " 25%" }} />
                    <p className='mt-3'>Stir all the above ingredients until icy cold and strain over a glass. Top up with water.</p>
                    <h5>RECIPE FOR HOPS DISTILLATE</h5>
                    <h6 className='mt-4'>INGREDIENTS</h6>
                    <p className='mt-4'>750 ml Vodka</p>
                    <p>100 gms Hops</p>
                    
                    <p className='mt-4'>
                        Set Rotavap to distill for 3h at 40 º C bath, 100 vacuum pump and chiller at 0 º C. Place the<br />
                        ingredients into a flask and distill until all the liquid is collected at the other end. Measure the<br />
                        ABV with a refractometer and rectify with mineral water until ABV touches 43%.<br />
                        Store in a bottle.<br />
                    </p>
